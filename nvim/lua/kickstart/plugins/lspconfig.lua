    ...
    config = function()
      ...
      vim.api.nvim_create_autocmd('LspAttach', {
        ...
        callback = function(event)
          ...
          if client and client_supports_method(client, 'callHierarchy/incomingCalls', event.buf) then
            map('gic', function()
              Snacks.picker.lsp_incoming_calls()
            end, '[G]oto [I]ncoming [C]all ')
          end
        end,
      })
...
do
  ...
  handlers = {
    ...
    ["rust_analyzer"] = function()
      ...
      -- IMPORTANT: do NOT let mason-lspconfig point cmd to ~/.local/share/nvim/mason/...
      server.cmd = { "rust-analyzer" }
